    ...
    expect(wrapper.html()).toMatchInlineSnapshot(`
      "<div class="page-container">
        <div class="card">
          ...
          <p> It took 3 days to build the intro page, mainly because I chose to draw all the assets. I'll be rolling this out piece by piece over the next few days. </p>
